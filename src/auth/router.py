...
from src.user.schemas import UserResponse, UserSchema
from src.user import services as repositories_users
...
async def signup(body: UserSchema, db: AsyncSession = Depends(get_db)):
    ...
    if exist_user:
        raise HTTPException(status_code=status.HTTP_409_CONFLICT, detail='ACCOUNT EXIST')
