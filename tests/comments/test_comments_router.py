...
class TestUpdateCommentHandler(unittest.IsolatedAsyncioTestCase):

    def setUp(self):
        self.mock_db = AsyncMock(spec=AsyncSession)
        self.mock_comment = CommentResponseSchema(id=1, content="Updated comment")
        self.mock_user = User(id=1, username="testuser", email="test@example.com")
...
class TestDeleteCommentHandler(unittest.IsolatedAsyncioTestCase):

    def setUp(self):
        self.mock_db = AsyncMock(spec=AsyncSession)
        self.mock_comment = CommentResponseSchema(id=1, content="Test comment")
